...
const DashboardLayout = () => {
  ...
  const dashboardPath = isDoctorLike ? "/doctor-dashboard" : isStaff ? "/staff-dashboard" : "/patient-dashboard";
  ...
  return (
    <div className={`dashboard-container ${isDoctorLike ? "dashboard-doctor" : "dashboard-patient"}`}>
      
      {/* Sidebar */}
      <aside className="sidebar">
        <h2 className="sidebar-title">
          {role === "admin" ? "Admin Panel" : isDoctorLike ? "Doctor Panel" : "Patient Panel"}
        </h2>
